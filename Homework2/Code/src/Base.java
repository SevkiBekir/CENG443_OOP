...
public class Base extends Part implements Robot {
    ...
    public synchronized void draw(Graphics2D g2d) {
        ...
        if (isWaiting || isShutdown) {
            g2d.fillOval(162, 142, 15, 15);
        }
    ...
    public synchronized void wearAndTear() {
        ...
        switch (Runner.random.nextInt(Runner.breakdownProbabilityConstant)) {
            case 0:
                arm = null;
                System.out.printf("Robot %02d : Arm broken!%n", serialNo);
                refresh = true;
                break;
            case 1:
                payload = null;
                System.out.printf("Robot %02d : Payload broken!%n", serialNo);
                refresh = true;
                break;
            case 2:
                logic = null;
                System.out.printf("Robot %02d : Logic broken!%n", serialNo);
                refresh = true;
                break;
        }
    ...
    public void run() {
        ...
        while (Runner.factory.stopProduction == false) {
            ...
            if ((arm != null) && (payload != null) && (logic != null)) {
                ...
                System.out.printf("Robot %02d : Waiting for maintenance!%n", serialNo);
                isWaiting = true;
                ...
                synchronized (this) {
                    while ((arm == null) | (payload == null) | (logic == null)) {
                        ...
                        if (Runner.factory.stopProduction == true) {
                            break;
                        }
                    }
                }
                ...
                System.out.printf("Robot %02d : Fixed, going back to work.%n", serialNo);
                isWaiting = false;
            ...
            try {
                Thread.sleep(Runner.robotSleepDurationConstant);
            } catch (InterruptedException ex) { /* Do nothing */ }
        }
